...
<nav class="nav navbar-inverse navbar-fixed-top" >
   ...
   <div class="container">
    ...
    <h2 style="text-align: center;color:red;padding-top: 15px;">Work Experience</h2>
    <form action="resume_work" style="margin-left: 15px;margin-right: 10px;" method="post">
    <div id="free">
    <div class="form-group">
      <label for="email">Company Name:</label>
      <input type="text" class="form-control" id="email" placeholder="Company  Name" name="comp_name" >
       <label for="email">Position:</label>
      <input type="text" class="form-control" id="email" placeholder="percentage" name="position" >
    ...
    <!--  <button type="button" class="btn btn-default center-block" id="btn">Add More Field</button>-->
    ...
    <script>
      $(document).ready(function(){
    	  $("#btn").click(function(){
    		  var form = '<div class="form-group"><label for="email">Company Name:</label><input type="text" class="form-control" id="email" placeholder="Company  Name" name="comp_name" > <label for="email">Position:</label> <input type="text" class="form-control" id="email" placeholder="percentage" name="position" > <label for="email">Start Date:</label><input type="date" class="form-control" id="email" name="start_date" > <label for="email">End Date:</label> <input type="date" class="form-control" id="email" name="end_date" ></div>';
