...
<nav class="nav navbar-inverse navbar-fixed-top" >
    ...
    <h2 style="text-align: center;color:red;padding-top: 15px;">Work Skills</h2>
    <form action="resume_skills" style="margin-left: 15px;margin-right: 10px;" method="post">
    <div id="free">
    <div class="form-group">
      <input type="text" class="form-control" id="email" placeholder="Ex: Web Development, Maeketing, etc.." name="skill" ><br>
        </div>
    </div>
    <button type="button" class="btn btn-default center-block" id="btn">Add More Skills</button>
    ...
    <script>
      $(document).ready(function(){
    	  $("#btn").click(function(){
    	    ...
    	    var form = '<input type="text" class="form-control" id="email" placeholder="Ex: Web Development, Maeketing, etc.." name="skill" ><br>';     
